...
#                in this implementation, we consider the threshold which lead to 0.99 of
#                the maximum/minimum value of the activation function as the saturating threshold.
