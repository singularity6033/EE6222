...
#                in this implementation, we consider the threshold which lead to 0.99 of the
#                maximum/minimum value of the activation function as the saturating threshold.
...
#                  scalemode=2  will scale the features for each hidden neuron separately.
#                  scalemode=3 will scale the range of the randomization for uniform diatribution.
class option:
