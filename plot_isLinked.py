...
ax[0].set_title('effect of direct links from the input layer to the output layer in train set', fontsize=20)
ax[0].set_xticks(x)
...
ax[1].set_title('effect of direct links from the input layer to the output layer in test set', fontsize=20)
ax[1].set_xticks(x)
